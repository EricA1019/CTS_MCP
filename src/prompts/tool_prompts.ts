...
import { PromptTemplate, PromptMessage } from '../types.js';
 ...
 */
export const SCAN_SIGNALS_PROMPT: PromptTemplate = {
    ...
    const messages: PromptMessage[] = [
      {
        ...
        content: {
          type: 'text',
          text: `I've scanned the project and found ${signalCount} signals. ${
            hasIssues
 ...
 */
export const ANALYZE_PROJECT_PROMPT: PromptTemplate = {
    ...
    const messages: PromptMessage[] = [
      {
        ...
        content: {
          type: 'text',
          text: `Project analysis (${analysisType}) is complete. ${
            issueCount > 0
 ...
 */
export const SUGGEST_REFACTORING_PROMPT: PromptTemplate = {
 ...
 */
export const RENDER_ARTIFACT_PROMPT: PromptTemplate = {
    ...
    const messages: PromptMessage[] = [
      {
        ...
        content: {
          type: 'text',
          text: `Artifact rendered successfully: ${artifactType}.${
            dataPoints ? ` Visualizing ${dataPoints} data points.` : ''
          }${
            renderTime ? ` Render time: ${renderTime}ms.` : ''
          } The artifact should now be visible in the editor. Use it to identify patterns and optimization opportunities.`,
        },
      },
    ];
 ...
 */
export const EXPORT_TO_SHRIMP_PROMPT: PromptTemplate = {
 ...
 */
export const ERROR_RECOVERY_PROMPT: PromptTemplate = {
...
export const ALL_TOOL_PROMPTS: PromptTemplate[] = [
  SCAN_SIGNALS_PROMPT,
