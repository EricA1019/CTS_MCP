...
import { validateToolResponse, ExportToShrimpResponseSchema } from '../schemas.js';
 ...
 */
export function convertHopToShrimpTask(hop: HopPlan): ShrimpTask {
 ...
 */
export function convertSubHopToTask(subHop: SubHop, parentHopId: string): ShrimpTask {
 ...
 */
export const ctsExportToShrimpHandler: ToolHandler = async (args: Record<string, unknown>) => {
  ...
  try {
    ...
    const response = {
      ...
      toolName: 'CTS_Export_to_Shrimp' as const,
 ...
 */
export const ctsExportToShrimpTool: ToolDefinition = {
