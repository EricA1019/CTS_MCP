...
import { validateToolResponse, ScanSignalsResponseSchema } from '../schemas.js';
 ...
 */
export function createScanSignalsHandler(engine: ArtifactEngine): ToolHandler {
  return async (args: Record<string, unknown>) => {
    ...
    if (params.renderMap) {
      const renderResult = await engine.renderArtifact(
        'signal_map',
        {
          signals: allSignals,
 ...
 */
export const scanProjectSignalsTool: ToolDefinition = {
