 ...
 */
export const STAGE_TEMPLATES: PromptTemplate[] = [
  {
 ...
 */
export function getStageTemplate(stage: string): PromptTemplate | undefined {
 ...
 */
export function substituteVariables(template: string, data: Record<string, unknown>): string {
  let result = template;
 ...
 */
export function renderPrompt(stage: string, context: Record<string, unknown>): string | null {
