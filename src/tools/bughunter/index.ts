...
import { validateToolResponse, BughunterResponseSchema } from '../../schemas.js';
 ...
 */
export const bughunterTool: ToolDefinition = {
  name: 'CTS_Bughunter',
 ...
 */
export function createBughunterHandler(): ToolHandler {
