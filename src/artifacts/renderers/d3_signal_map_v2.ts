...
import { detectCommunities } from '../clustering/community_detection.js';
...
export class ClusteredSignalMapRenderer implements ArtifactRenderer {
...
<body>
   ...
   */
  private getCommunityDetectionScript(): string {
    return `
