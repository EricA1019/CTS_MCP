    ...
    while (improved && iterations < maxIterations) {
        ...
        for (const node of nodes) {
            ...
            for (const targetCluster of neighborClusters) {
                const gain = calculateModularityGain(nodeId, currentCluster, targetCluster, adjacency, degrees, clusters, nodeToCluster, m2);
                if (gain > bestGain) {
                    bestGain = gain;
...
function calculateModularityGain(nodeId, fromCluster, toCluster, adjacency, degrees, clusters, nodeToCluster, m2) {
    ...
    const gain = (edgesToTarget - edgesFromSource) / m2 -
...
//# sourceMappingURL=community_detection.js.map