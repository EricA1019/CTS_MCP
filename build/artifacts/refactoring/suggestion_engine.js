...
import { isSnakeCase, validateNaming } from './naming_validator.js';
...
export class RefactoringEngine {
     ...
     */
    async generateSuggestions(graph) {
        ...
        for (const [signalName, defs] of graph.definitions) {
            const violation = validateNaming(signalName, defs.map(d => d.filePath));
            if (violation) {
                suggestions.push({
     ...
     */
    computeSimilarityConfidence(s1, s2, distance) {
...
//# sourceMappingURL=suggestion_engine.js.map