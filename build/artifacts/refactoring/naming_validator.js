 ...
 */
export function validateNaming(signalName, filePaths) {
    // Check for spaces
 ...
 */
export function hasCommonPattern(signalName) {
 ...
 */
export function extractSuffix(signalName) {
 ...
 */
export function extractPrefix(signalName) {
    const prefixMatch = signalName.match(/^(on)_/);
    return prefixMatch ? prefixMatch[1] : null;
}
//# sourceMappingURL=naming_validator.js.map