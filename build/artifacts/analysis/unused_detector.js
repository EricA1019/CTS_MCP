...
export class UnusedDetector {
     ...
     */
    createIsolatedSignal(signalName, defs) {
        return {
            signalName,
     ...
     */
    createOrphanSignal(signalName, defs) {
     ...
     */
    createDeadEmitterSignal(signalName, emits) {
     ...
     */
    computeDeadEmitterConfidence(emits) {
...
//# sourceMappingURL=unused_detector.js.map