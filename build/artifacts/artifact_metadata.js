...
export class CacheTagger {
     ...
     * ```
     */
    static generateKey(type, data, version) {
     ...
     */
    static generateKeyLegacy(type, data) {
        const dataJson = JSON.stringify(data);
        const hash = createHash('sha256')
            .update(dataJson)
            .digest('hex')
     ...
     */
    static extractVersion(entry) {
        return entry?.schemaVersion;
    }
}
//# sourceMappingURL=artifact_metadata.js.map