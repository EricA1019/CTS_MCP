...
export class ReasoningEngine {
    state;
    initialTotalThoughts;
    constructor(initialThoughts = 10) {
     ...
     * @param context - Reasoning context
     */
    updateStateForStage(stage, context) {
        ...
        switch (stage) {
            ...
            case 'Critical Questioning':
                ...
                if (context.previous_thoughts && context.previous_thoughts.length > 0) {
                    this.state.assumptions_challenged.push(`Assumption from thought ${this.state.thought_number - 1}`);
                }
                break;
            case 'Analysis':
