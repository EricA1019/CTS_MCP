 ...
 */
export async function collectMetrics(projectPath, files) {
    const metrics = {
    ...
    if (gdFiles.length > 0) {
        ...
        metrics.complexity.average = Math.round(metrics.complexity.total / gdFiles.length);
    }
 ...
 */
export function getComplexityBreakdown(metrics) {
 ...
 */
export function getTopComplexFiles(metrics, n = 10) {
 ...
 */
export function getTopLargestFiles(metrics, n = 10) {
